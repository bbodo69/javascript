...
<body>
	...
	<%
		if(count > 0){
		// 10 페이지씩 끊어서 목록 보여주게 만들기
		//총 몇 페이지 나오는지 계산 (pageSize로 나누고 남은 글이 하나라도 있으면 1페이지 더하기)
		...
		// 마지막에 보여지는 페이지뷰어에 페이지 개수가 
		// 10 미만일 경우 마지막 페이지 번호가 engPage가 되게 설정
		int endPage = startPage + pageBlock - 1;
		if(endPage > pageCount) endPage = pageCount;
		
		// startPage가 10보다 크면 < 보여주기(현)
