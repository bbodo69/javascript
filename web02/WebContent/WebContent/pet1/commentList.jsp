...
<%
	...
	else 	{pageNum = "1"; System.out.println("null임");}
...
<body>
	...
	<section>
		<h1 id="listSub">펫시터 이용후기</h1>
		<br/>
		<h1>
		<button onclick="window.location.href='getpetList.jsp'">펫시터구하기</button>
		<button onclick="window.location.href='commentWriteForm.jsp?pageNum=<%=pageNum%>'">후기작성하기</button>
		</h1>
		<table>
			<tr>
		...
		<%//페이지뷰어 만들기
			if(count > 0){
				...
				<a href="commentList.jsp?pageNum=<%=startPage-1%>"> &lt; </a>
				<%}
				//5. 페이지 반복해서 뿌려주기
				...
				<a href="commentList.jsp?pageNum=<%=endPage+1%>"> &gt; </a>
				<%}
			}%>
			<br/><br/>
