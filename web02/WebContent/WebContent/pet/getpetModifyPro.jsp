...
<%
	...
	try{
		...
		if(sysname != null){
			if(img != null){
				File f = new File("D:\\hyunsu\\classclass\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp1\\wtpwebapps\\web\\getpetImage\\"+img);
				f.delete();
			}
	...
	<body>
		<table>
			<tr>
				...
				<button onclick="window.location.href='getpetContent.jsp?num=<%=num%>&pageNum=<%=pageNum%>'">수정글확인</button>
				</td>
			</tr>
		</table>
		<br/>
