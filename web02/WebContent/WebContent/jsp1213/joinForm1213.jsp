...
<body>
	...
	<p class="p"></p>
	<h1 class="h1"> 회원가입 </h1>
	<form method="post" action="pro1213.jsp" onsubmit="return check()" name="inputform" >
       ...
       <tr>
           <td>취미</td>
           <td><input type="checkbox" name="a" value="a">a</td>
           <td><input type="checkbox" name="b" value="b">b</td>
           <td><input type="checkbox" name="c" value="c">c</td>
           <td><input type="checkbox" name="d" value="d">d</td>
       </tr>
       <tr>
       		<td colspan="5">
