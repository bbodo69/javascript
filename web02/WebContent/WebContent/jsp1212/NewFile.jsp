...
<title>Insert title here</title>
   ...
   <script>function input(){
	    var input = document.inputform;
        if(!document.inputform.id.value){alert("아이디 입력!!");return false;}            
        if(!document.inputform.pw.value){alert("비밀번호 입력!!");return false;}            
        if(!document.inputform.pwCh.value){alert("비밀번화확인 입력!!");return false;}            
        if(document.inputform.pwCh.value !== document.inputform.pw.value){alert("비밀번호 일치!!");return false;}
  	    }
   </script>
...
<form method="post" action="semangat2.jsp" onsubmit="return check()" 
			name="inputform" >
