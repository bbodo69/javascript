...
<script>
            ...
            if(!document.inputform.id.value){//input태그안에 값 X
                alert("아이디를 입력하세요.");//경고창 띄우고
                return false;               // false를 리턴.
            }
            if(!document.inputform.pw.value){//input태그안에 값 X
                alert("비밀번호를 입력하세요.");//경고창 띄우고
                return false;               // false를 리턴.
            }
            if(!document.inputform.pwCh.value){//input태그안에 값 X
                alert("비밀번호 확인을 하세요.");//경고창 띄우고
                return false;               // false를 리턴.
            }
            if(!document.inputform.name.value){//input태그안에 값 X
                alert("이름을 입력하세요.");//경고창 띄우고
                return false;               // false를 리턴.
            }
                if(input.pw.value != input.pwCh.value){
                    alert("비밀번호를 동일하게 적용하세요");
                    return false;
                }
        }
    </script>
