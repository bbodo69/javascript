...
//////////////////////////////////////////////////////////////	
	...
	public void deleteContent(String id, int num) {
		try {
			conn = getConnection();
	...
	public List myPetListAll() {
		...
		try {					
			...
			int count = 0;
			String sql1 = "select count(*) from addpet";
			pstmt = conn.prepareStatement(sql1);
			rs = pstmt.executeQuery();
			if(rs.next()) {
				count = rs.getInt(1);
			...
			String sql = "select * from addpet order by id";
			pstmt = conn.prepareStatement(sql);
			rs = pstmt.executeQuery();
			if(rs.next()) {
				do {
	...
	public List myPetListNameAdmin(String keyword) {
		QNADAO dao = new QNADAO();
		int count = 0;
		List list = null;
		...
		try {
			conn = getConnection();
			String sql1 = "select count(*) from addpet where name = ?";
			pstmt = conn.prepareStatement(sql1);			
			...
			list = new ArrayList(count);
			String sql = "select * from addpet where name = ?";
			pstmt = conn.prepareStatement(sql);			
			pstmt.setString(1, keyword);
			rs = pstmt.executeQuery();
			if(rs.next()) {
	...
	public List myPetListKindAdmin(String keyword) {
		QNADAO dao = new QNADAO();
		int count = 0;
		List list = null;
		...
		try {
			conn = getConnection();
			String sql1 = "select count(*) from addpet where kind = ?";
			pstmt = conn.prepareStatement(sql1);			
			pstmt.setString(1, keyword);
			rs = pstmt.executeQuery();
			if(rs.next()) {
			...
			list = new ArrayList(count);
			String sql = "select * from addpet where kind = ?";
			pstmt = conn.prepareStatement(sql);			
			pstmt.setString(1, keyword);
			rs = pstmt.executeQuery();
			if(rs.next()) {
	...
	public List myPetListAgeAdmin(String keyword) {
		QNADAO dao = new QNADAO();
		int count = 0;
		List list = null;
		...
		try {
			conn = getConnection();
			String sql1 = "select count(*) from where addpet age = ?";
			pstmt = conn.prepareStatement(sql1);			
			pstmt.setString(1, keyword);
			rs = pstmt.executeQuery();
			if(rs.next()) {
			...
			list = new ArrayList(count);
			String sql = "select * from addpet where age = ?";
			pstmt = conn.prepareStatement(sql);			
			pstmt.setString(1, keyword);
			rs = pstmt.executeQuery();
			if(rs.next()) {
	...
	public List myPetListIdAdmin(String keyword) {
		QNADAO dao = new QNADAO();
		int count = 0;
		List list = null;
		...
		try {
			conn = getConnection();
			String sql1 = "select count(*) from addpet where id = ?";
			pstmt = conn.prepareStatement(sql1);			
			pstmt.setString(1, keyword);
			rs = pstmt.executeQuery();
			if(rs.next()) {
	...
	public List getMyContentsAdmin() {
		
		QNADAO dao = new QNADAO();
		List list = null;
		int count = dao.countMyContentsAdmin();
	
			try {
			conn = getConnection();
			String sql1 = "select * from board order by reg";  
			pstmt = conn.prepareStatement(sql1);			
			rs = pstmt.executeQuery();
			if(rs.next()) {				
				list = new ArrayList(count);
	...
	public int countMyContentsAdmin() {
		int count = 0;
		try {
			conn = getConnection();
	...
	public List myPetList(String id,int startNum,int endNum,int contentsSize) {
		...
		try {
			conn = getConnection();
			list = new ArrayList(count);
			String sql = "select * from (select a.*, rownum as rnum, count(*) over() as totcnt from (select * from addpet order by num)a)where id=? and rnum >= ? and rnum <= ?";
//			String sql1 = "select * from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from qna order by reg)a)where rnum >= ? and rnum <= ?";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, id);
	...
	public List myPetListName(String id, String keyword, int startNum,int endNum,int contentsSize) {
		...
		try {
			conn = getConnection();
			list = new ArrayList(count);
			String sql = "select * from (select a.*, rownum as rnum, count(*) over() as totcnt from (select * from addpet order by num)a)where id=? and name=? and rnum >= ? and rnum <= ?";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, id);
			pstmt.setString(2, keyword);
	...
	public List myPetListKind(String id, String keyword, int startNum,int endNum,int contentsSize) {
		...
		try {
			conn = getConnection();
			list = new ArrayList(count);
			String sql = "select * from (select a.*, rownum as rnum, count(*) over() as totcnt from (select * from addpet order by num)a)where id=? and kind=? and rnum >= ? and rnum <= ?";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, id);
			pstmt.setString(2, keyword);
			pstmt.setInt(3, endNum);
	...
	public List myPetListAge(String id, String keyword, int startNum,int endNum,int contentsSize) {
		...
		try {
			conn = getConnection();
			list = new ArrayList(count);
			String sql = "select * from (select a.*, rownum as rnum, count(*) over() as totcnt from (select * from addpet order by num)a)where id=? and age=? and rnum >= ? and rnum <= ?";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, id);
			pstmt.setString(2, keyword);
			pstmt.setInt(3, endNum);
	...
	public int countMyPetListAll() {
		int count = 0;
		try {
			conn = getConnection();
			String sql = "select count(*) from addpet";
			pstmt = conn.prepareStatement(sql);
			rs = pstmt.executeQuery();
			if(rs.next()) {				
				count = rs.getInt(1);
	...
	public List myPetListAll(int startNum, int endNum, int contentsSize) {
		...
		try {
			...
			String sql1 = "select * from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from addpet order by num)a)where rnum >= ? and rnum <= ?";
			pstmt=conn.prepareStatement(sql1);
			pstmt.setInt(1, endNum);
			pstmt.setInt(2, startNum);
			rs = pstmt.executeQuery();
	...
	public List myPetListIdAdmin(String keyword, int startNum, int endNum, int contentsSize) {
		QNADAO dao = new QNADAO();		
		List list = null;
		...
		try {					
			conn = getConnection();
			list = new ArrayList(contentsSize);			
			String sql1 = "select * from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from addpet)a)where rnum >= ? and rnum <= ? and id=?";			
			pstmt = conn.prepareStatement(sql1);
			pstmt.setInt(1, endNum);
			pstmt.setInt(2, startNum);
	...
	public List myPetListNameAdmin(String keyword, int startNum, int endNum, int contentsSize) {
		QNADAO dao = new QNADAO();		
		List list = null;
		...
		try {					
			conn = getConnection();
			list = new ArrayList(contentsSize);			
			String sql1 = "select * from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from addpet)a)where rnum >= ? and rnum <= ? and name=?";			
			pstmt = conn.prepareStatement(sql1);
			pstmt.setInt(1, endNum);
			pstmt.setInt(2, startNum);
			pstmt.setString(3, keyword);			
	...
	public List myPetListKindAdmin(String keyword, int startNum, int endNum, int contentsSize) {
		QNADAO dao = new QNADAO();		
		List list = null;
		...
		try {					
			conn = getConnection();
			list = new ArrayList(contentsSize);			
			String sql1 = "select * from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from addpet)a)where rnum >= ? and rnum <= ? and kind=?";			
			pstmt = conn.prepareStatement(sql1);
			pstmt.setInt(1, endNum);
			pstmt.setInt(2, startNum);
			pstmt.setString(3, keyword);			
	...
	public List myPetListAgeAdmin(String keyword, int startNum, int endNum, int contentsSize) {
		QNADAO dao = new QNADAO();		
		List list = null;
		...
		try {					
			conn = getConnection();
			list = new ArrayList(contentsSize);			
			String sql1 = "select * from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from addpet)a)where rnum >= ? and rnum <= ? and age=?";			
			pstmt = conn.prepareStatement(sql1);
			pstmt.setInt(1, endNum);
			pstmt.setInt(2, startNum);
			pstmt.setString(3, keyword);			
	...
	public int countMyContents(String id, int startNum, int endNum, int contentsSize) {
		int count = 0;
		try {
			conn = getConnection();			
			String sql = "select count(*) from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from board)a)where rnum >= ? and rnum <= ? where id=?";
			pstmt = conn.prepareStatement(sql);			
	...
	public List getMyContents(String id, int startNum, int endNum, int contentsSize) {
			...
			int count = dao.countMyContents(id);
				...
				try {
				conn = getConnection();
				String sql = "select * from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from board)a)where rnum >= ? and rnum <= ? and id=?";  
				pstmt = conn.prepareStatement(sql);
				pstmt.setInt(1, endNum);
				pstmt.setInt(2, startNum);
				pstmt.setString(3, id);
	...
	public List getMyContentsAdmin(int startNum, int endNum, int contentsSize) {
		...
		int count = dao.countMyContentsAdmin();
			...
			try {
			conn = getConnection();
			String sql = "select * from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from board)a)where rnum >= ? and rnum <= ?";
			pstmt = conn.prepareStatement(sql);
			pstmt.setInt(1, endNum);
			pstmt.setInt(2, startNum);
			rs = pstmt.executeQuery();
	...
	public int countMyContentsAdmin(int startNum, int endNum, int contentsSize) {
		int count = 0;
		try {
			conn = getConnection();
			String sql = "select count(*) from ( select a.*, rownum as rnum, count(*) over() as totcnt from (select * from board)a)where rnum >= ? and rnum <= ?";
			pstmt = conn.prepareStatement(sql);
			pstmt.setInt(1, endNum);
			pstmt.setInt(2, startNum);
			rs = pstmt.executeQuery();
