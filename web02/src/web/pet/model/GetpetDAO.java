...
public class GetpetDAO {
	...
	public List getpetList(int startRow, int endRow) {
		...
		try {
			...
			String sql = "select id, num, subject, content, readcount, img, ip, area, petsit, reg, r "
					+ "from (select id, num, subject, content, readcount, img, ip, area, petsit, reg, rownum r "
					+ "from (select id, num, subject, content, readcount, img, ip, area, petsit, reg "
	...
	public void insertArticle(GetpetDTO article) {
		...
		try {
			...
			sql = "insert into getpet(id, num, subject, content, img, ip, area, petsit, reg) "
