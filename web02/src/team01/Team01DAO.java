...
public class Team01DAO {
	...
	public Team01DTO myContents(String id) {
		Team01DTO dto = new Team01DTO();
		try {
	...
	public void addPet(Team01DTO dto) {
...
//////////////////////////////////////////////////////////////	
	public Team01DTO searchMyPet(String category, String keyword) {
		Team01DTO dto = null;
		try {
			conn = getConnection();
	...
	public void addPetDelete (String id, int i) {
		...
		Team01DTO dto = (Team01DTO)list.get(i);
		String name = dto.getName();
		String kind = dto.getKind();
		String age = dto.getAge();
